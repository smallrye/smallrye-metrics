...
public class LegacyBaseMetrics implements MeterBinder {
    ...
    private void garbageCollectionMetrics(MeterRegistry registry) {
        for (GarbageCollectorMXBean gc : ManagementFactory.getGarbageCollectorMXBeans()) {
            FunctionCounter.builder("gc.total", gc, GarbageCollectorMXBean::getCollectionCount)
                    .description(
                    ...
                    .tag("name", gc.getName())
                    .register(registry);
            FunctionCounter.builder("gc.time", gc, GarbageCollectorMXBean::getCollectionTime)
                    .description(
    ...
    private void classLoadingMetrics(MeterRegistry registry) {
        ...
        FunctionCounter.builder(TOTAL_UNLOADED_CLASS_COUNT, classLoadingMXBean, ClassLoadingMXBean::getUnloadedClassCount)
                ...
                .register(registry);
        Gauge.builder(CURRENT_LOADED_CLASS_COUNT, classLoadingMXBean::getLoadedClassCount)
    ...
    private void baseOperatingSystemMetrics(MeterRegistry registry) {
        ...
        Gauge.builder(SYSTEM_LOAD_AVERAGE, operatingSystemMXBean::getSystemLoadAverage)
                ...
                .register(registry);
        Gauge.builder(CPU_AVAILABLE_PROCESSORS, operatingSystemMXBean::getAvailableProcessors)
                .description(
        ...
        if (!nativeMode
            ...
            try {
                ...
                Gauge.builder(PROCESS_CPU_LOAD, internalOperatingSystemMXBean::getProcessCpuLoad)
    ...
    private void threadingMetrics(MeterRegistry registry) {
        ...
        Gauge.builder(THREAD_COUNT, thread::getThreadCount)
    ...
    private void baseMemoryMetrics(MeterRegistry registry) {
        ...
        Gauge.builder(MEMORY_COMMITTED_HEAP, memoryMXBean.getHeapMemoryUsage()::getCommitted)
                ...
                .register(registry);
        Gauge.builder(MEMORY_MAX_HEAP, memoryMXBean.getHeapMemoryUsage()::getMax)
                ...
                .register(registry);
        Gauge.builder(MEMORY_USED_HEAP, memoryMXBean.getHeapMemoryUsage()::getUsed)
