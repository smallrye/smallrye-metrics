...
public class RegistrationCornerCasesTest {
    ...
    public void lambdaExpression() {
        ...
        Assert.assertEquals(MetricType.GAUGE, registry.getMetadata().get("test").getTypeRaw());
        Assert.assertEquals(42L, registry.getGauges().get(new MetricID("test")).getValue());
    }
    ...
    public void lambdaExpressionCastToMultipleInterfaces() {
        ...
        Assert.assertEquals(MetricType.GAUGE, registry.getMetadata().get("test").getTypeRaw());
        Assert.assertEquals(18L, registry.getGauges().get(new MetricID("test")).getValue());
    }
    ...
    public void classThatImplementsMetricViaSuperClass() {
        ...
        Assert.assertEquals(MetricType.COUNTER, registry.getMetadata().get("test").getTypeRaw());
        Assert.assertEquals(13L, registry.getCounters().get(new MetricID("test")).getCount());
    }
    ...
    public void ambiguousClassButTypeIsProvidedDuringRegistration() {
        ...
        Assert.assertEquals(MetricType.COUNTER, registry.getMetadata().get("test").getTypeRaw());
        Assert.assertEquals(666L, registry.getCounters().get(new MetricID("test")).getCount());
    }
    ...
    public void anonymousClassThatImplementsMetricViaSuperClass() {
        ...
        Assert.assertEquals(MetricType.COUNTER, registry.getMetadata().get("test").getTypeRaw());
        Assert.assertEquals(145, registry.getCounters().get(new MetricID("test")).getCount());
    }
    ...
    public void anonymousCounter() {
        ...
        Assert.assertEquals(3L, registry.getCounters().get(new MetricID("test")).getCount());
    }
